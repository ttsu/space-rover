...
export class PlanetRunMenuScene extends Scene {
  ...
  onInitialize() {
    ...
    this.bankLabel = new Label({
      ...
      pos: vec(cx, this.engineRef.drawHeight / 2 - 60),
    ...
    const startRunButton = new Actor({
      pos: vec(cx, this.engineRef.drawHeight / 2 + 10),
      width: 200,
      height: 56,
    ...
    this.upgradeButton = new Actor({
      pos: vec(cx, this.engineRef.drawHeight / 2 + 78),
      width: 200,
      height: 48,
    ...
    const exitButton = new Actor({
      pos: vec(cx, this.engineRef.drawHeight / 2 + 138),
      width: 200,
      height: 48,
    ...
    if (isTouchDeviceCapable()) {
      this.touchToggleButton = new Actor({
        pos: vec(cx, this.engineRef.drawHeight / 2 + 198),
        width: 200,
        height: 40,
